        ...
        <div className="projects">
            ...
            <div className="container">
                <div className="project-card">
                    ...
                    <p className="github-url"><a href="https://github.com/Izzeddin-Samara/Fitness_Track"><button>View on GitHub</button></a></p>
                </div>
                ...
                <div className="project-card">
                    ...
                    <h5 id="techi">Technology Stack</h5>
                    <ul>
                        <li><p>Frontend: HTML, CSS, JavaScript and Bootstrap</p> </li>
                        <li><p>Backend: Django / Python</p> </li>
                        <li><p>Database: MySQL</p> </li>
                    </ul>
                    <p className="github-url"><a href="https://github.com/talakh1798/Technicians-Hub"><button>View on GitHub</button></a></p>
                </div>
